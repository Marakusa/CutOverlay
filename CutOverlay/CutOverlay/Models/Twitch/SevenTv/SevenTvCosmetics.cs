...
public class Badge
{
    ...
    [JsonProperty("urls")] public List<List<string>> Urls { get; set; }

    [JsonProperty("users")] public List<string> Users { get; set; }
}

public class DropShadow
{
    [JsonProperty("x_offset")] public double XOffset { get; set; }

    [JsonProperty("y_offset")] public double YOffset { get; set; }
...
public class Paint
{
    ...
    [JsonProperty("stops")] public List<Stop> Stops { get; set; }

    [JsonProperty("repeat")] public bool Repeat { get; set; }

    [JsonProperty("angle")] public int Angle { get; set; }

    [JsonProperty("drop_shadows")] public List<DropShadow> DropShadows { get; set; }
...
public class SevenTvCosmetics
{
    ...
    [JsonProperty("paints")] public List<Paint> Paints { get; set; }
}
